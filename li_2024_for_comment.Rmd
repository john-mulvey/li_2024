...
In Figure 3H of the authors paper, there are fewer data points than the stated sample size. Here we calculate the overall average percentage of values that are missing in the proteomics dataset, across all proteins and all samples.
```{r}
